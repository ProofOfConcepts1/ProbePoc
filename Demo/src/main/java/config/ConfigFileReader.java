...
//		System.getProperty("user.dir");
	...
	public String getRow() throws IOException, SQLException {
		String row = properties.getProperty("row");
		if (row != null)
			return row;
		else
			throw new RuntimeException("row not specified in the Configuration.properties file.");
	}
	...
	public String getColumn() throws IOException, SQLException {
		String cols = properties.getProperty("column");
		if (cols != null)
			return cols;
		else
			throw new RuntimeException("cols not specified in the Configuration.properties file.");
	}
